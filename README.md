...
2. **[Frontend Client](./frontend/README.md)**: A React SPA that renders the interactive chess board, evaluation graphs (via Chart.js), and engine lines in a premium dark-mode UI.
